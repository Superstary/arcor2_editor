...
public class TrackedImageManager : MonoBehaviour
{
    ...
    protected virtual void OnTrackingFound()
    {
        if (mTrackableBehaviour)
        {
            Debug.Log("Tracked position :" + mTrackableBehaviour.transform.position);
            Debug.Log("Tracked GM position :" + mTrackableBehaviour.gameObject.transform.position);
            Debug.Log("Tracked name :" + mTrackableBehaviour.Trackable.Name);
